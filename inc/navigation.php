...
if ( ! function_exists( 'thirdrail_main_nav' ) ) {
	function thirdrail_main_nav() {
	    wp_nav_menu(array(
	        ...
	        'walker' => new thirdrail_Main_Nav_Walker(),
	    ));
	}
}

if ( ! function_exists( 'thirdrail_mobile_nav' ) ) {
	function thirdrail_mobile_nav() {
	    wp_nav_menu(array(
	        'container' => false,                           // Remove nav container
	        'container_class' => '',                        // Class of container
	        'menu' => '',                                   // Menu name
	        ...
	        'depth' => 2,                                   // Limit the depth of the nav
	        'fallback_cb' => false,                         // Fallback function (see below)
	        'walker' => new thirdrail_Mobile_Nav_Walker(),
	    ));
	}
}
